    ...
    <div class="outer-box">
         ...
         <div class="left-menu">
             <div class="left-input left-input-margin left-input-size">
                 ...
                 <a class="p-size" href="">Account Info</a>
             </div>
             <div class="left-input left-input-margin left-input-size">
         ...
         <div class="right-box">
             <div class="dashboard-title">
                 <svg class="svg-size-2 title-svg" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>                 <h3>Welcome, <?php  echo preg_replace('/@.*?$/', '', $_SESSION['email']); ?></h3>
             </div>
             <div class="input-dashboard">
                 <div class="left-input-box">
                     <svg class="svg-size-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207"></path></svg>
                     <label>Email:</label>
                     <p class="account-info"> <?php echo $_SESSION['email']; ?></p>
                 </div>
                 <div class="right-input-box">
                     <svg class="svg-size-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
